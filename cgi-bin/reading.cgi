							...
							<div class="two-columns-one">
								<div style="border:1px solid #DDD; background-color:#F0F0F0; padding:15px 10px;">
									<header class="single-entry-header">
										...
										<ul>
											<li>&bull; Annotate text yourself, or let computer try it</li>
											<li>&bull; Include images & audio</li>
											<li>&bull; Add more text as you go</li>
											<li>&bull; Go back and edit again later</li>
											<li>&bull; Build vocabulary list for student</li>
										</ul>
										<br>
										<h1 id="bottom_header" class="entry-title">For Students</h1>
										<ul>
											<li>&bull; Study annotations corrected by instructor</li>
											<li>&bull; Use highlighter to see word boundaries</li>
											<li>&bull; Lookup example sentences</li>
											<li>&bull; Practice vocabulary with flashcard tool</li>
										</ul>
									</header>
								</div>
							</div>
							...
							<div class="two-columns-one last">
								<div style="border:1px solid #DDD; background-color:#F0F0F0; padding:15px 10px;">
									<header class="single-entry-header">
										...
										<ul>
											<li><a href="$$LOCAL_state_ptr{webURL}/cgi-bin/openreading.cgi?blueprintid=533">Miyazawa Kenji : Ame ni mo Makezu</a></li>
											<li><a href="$$LOCAL_state_ptr{webURL}/cgi-bin/openreading.cgi?blueprintid=199">Ishigaki Rin : Shijimi</a></li>
											<li><a href="$$LOCAL_state_ptr{webURL}/cgi-bin/openreading.cgi?blueprintid=202">Yomiuri Shinbun : Shuukatu no Susume</a></li>
											<li><a href="$$LOCAL_state_ptr{webURL}/cgi-bin/openreading.cgi?blueprintid=205">Ishigaki Rin : Gake</a></li>
										</ul>
									</header>
								</div>
							</div>
